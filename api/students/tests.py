...
class TestViewEnrollStudent(TestCase):
    ...
    def test_enroll_student(self):
        response = self.client2.post("/api/students/enroll/", {"course_id": 1, "period": 20222})
    ...
    def test_raises_error_when_course_id_is_missing(self):
        response = self.client2.post("/api/students/enroll/", {"period": 20222})
    ...
    def test_raises_error_when_course_id_does_not_exist(self):
        response = self.client2.post("/api/students/enroll/", {"course_id": 2, "period": 20222})
        self.assertEqual(response.status_code, 400)
    
    def test_raises_error_when_period_format_is_wrong(self):
        response = self.client2.post("/api/students/enroll/", {"course_id": 1, "period": 20223})
        self.assertEqual(response.status_code, 400)
...
class TestViewCreateSubmission(TestCase):
    ...
    def test_create_submission(self):
        ...
        response = self.client2.post("/api/students/submission/", {"assignment_id": 1, "course_id": 1})
    ...
    def test_raises_error_when_assignment_id_is_missing(self):
        response = self.client2.post("/api/students/submission/", {"course_id": 1})
        self.assertEqual(response.status_code, 400)
    
    def test_raises_error_when_assignment_id_does_not_exist(self):
        response = self.client2.post("/api/students/submission/", {"assignment_id": 2, "course_id": 1})
        self.assertEqual(response.status_code, 400)